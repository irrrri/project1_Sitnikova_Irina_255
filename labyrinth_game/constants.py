...
ROOMS = {
    ...
    'garden': {
        'description': (
            'Светлый сад с фонтаном посередине. '
            'По дорожкам растут странные цветы.'
        ),
        'exits': {'south': 'armory', 'east': 'hidden_cave'},
        'items': ['flower', 'herb'],
        'puzzle': (
            'Фонтан шепчет: "Назовите растение, '
            'которое всегда возвращается весной."',
            'тюльпан'
        )
    },
    'hidden_cave': {
        'description': 'Тёмная пещера с блестящими кристаллами на стенах.',
        'exits': {'west': 'garden'},
